...
if ($version->RELEASE=='1.5') {
  ...
  define('CUSTOM_FB_SHARE_IMG','/plugins/content/facebooklikeandshare/media/fbicon.png');
}
    ...
    if ($enable_fb_comments || $enable_fb_like || $enable_fb_share || $enable_fb_send || $enable_fb_photo) {
      ...
      if ($this->params->get('fb_asynchronous','1') == '1') {
        $FbCode = "
           ...
           ".PHP_EOL;
        if ($fb_app_id != '') {
          $FbCode .= "js.src = '//connect.facebook.net/" . $fb_language . "/all.js#xfbml=1&status=0&appId=" . $fb_app_id . "';".PHP_EOL;
        } else {
          $FbCode .= "js.src = '//connect.facebook.net/" . $fb_language . "/all.js#xfbml=1&status=0';".PHP_EOL;
        }
        ...
        if ($fb_app_id != '') {
          $document->addScript("//connect.facebook.net/" . $fb_language . "/all.js#xfbml=1&status=0&appId=" . $fb_app_id);
        } else {
          $document->addScript("//connect.facebook.net/" . $fb_language . "/all.js#xfbml=1&status=0");
        }
      }
