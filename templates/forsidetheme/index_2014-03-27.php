...
jQuery(document).ready(function($){
var submenuLiCount = $("#SubMenu_levelThree li").length;
if(submenuLiCount>16){
  var submenuLength = 28.5*(submenuLiCount);
  var resultheight = submenuLength+'px';
...
<style type="text/css">
#SubImage {
    background: url('/templates/<?php echo  $this->template ;?>/images/forside.jpg') #fff center center scroll ;
    margin: 0px;
    padding: 0px;
 ...
 <jdoc:include type="message" />
  <div id="TemplateContent">
    <div class="wrapper" style="position: relative;">
	  ...
	  <!-- this is moved to module custom html
